...
def main() -> int:
    ...
    p_watch.add_argument("--pole-pairs", type=float, default=10.0,
                          help="motor_pole_pairs from urdf/rp1_drive.urdf (default 10.0, 20-pole "
                          "motor / 10 pole pairs -- corrected 2026-09-22, was wrongly 20.0) -- "
                          "used only to convert status_rpm (mechanical) to status_erpm_equiv for "
