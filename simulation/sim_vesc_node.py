...
matches --pole-pairs. Both default to 10 (20-pole motor / 10 pole pairs, corrected 2026-09-22 --
...
def main():
    ...
    parser.add_argument('--pole-pairs', type=float, default=10.0,
                        help="motor pole pairs, for the ERPM<->mechanical conversion; must match "
                             "rp1_drive.urdf's motor_pole_pairs (default: 10)")
